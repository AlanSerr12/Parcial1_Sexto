      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="producto/producto.php" target="base" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="venta/venta.php" target="base"  aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="productos/productos.php" target="base" aria-expanded="false">
                ...
                <span class="hide-menu">Real hasta la muerte</span>
              </a>
            </li>
            <li class="sidebar-item">
